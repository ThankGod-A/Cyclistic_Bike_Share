...
# 4. To calculate the Mode of day of week?
# Defined a function used to calcaulate the Mode
...
#Try rows = member_casual; Values = Averageof ride_length
...
# 6.To calculate the number of rides for users by day_of_week

Bike_rides %>% 
  group_by(user_type, day_of_week_1) %>% 
  summarise(Number_of_rides = n())
  
# 7. To calculate the number of rides for users
...
# 8.To calculate the number of rides for users per season?  
...
# 9. To calculate the number of rides per month
...
# 10. To calculate the most preferred time_of_day
...
# 11. The most preferred bike type
